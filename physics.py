...
class PhysicsEngine:
    ...
    ReaRearRightight_degrees = ntproperty("/SmartDashboard/drive/RearRight_Module/degrees", 0)
    ...
    def initialize(self, hal_data):
        ...
        self.ReaRearRightight_encoder = 0
    ...
    def update_sim(self, hal_data, now, tm_diff):
        ...
        try:
            ...
            self.ReaRearRightight_encoder += hal_data['CAN'][7]['value'] * tm_diff * 20

            self.FrontLeft_encoder %= 5
            self.FrontRight_encoder %= 5
            self.RearLeft_encoder %= 5
            self.ReaRearRightight_encoder %= 5
            ...
            hal_data['analog_in'][3]['avg_voltage'] = self.ReaRearRightight_encoder
        ...
        try:
            ...
            ReaRearRightightMotor = hal_data['CAN'][3]['value'] / 1023

            vx, vy, vw = four_motor_swerve_drivetrain(FrontLeftMotor, FrontRightMotor, RearLeftMotor, ReaRearRightightMotor, self.FrontLeft_degrees, self.FrontRight_degrees, self.RearLeft_degrees, self.ReaRearRightight_degrees, x_wheelbase=3, y_wheelbase=3.6, speed=9)
...
def four_motor_swerve_drivetrain(FrontLeftMotor, FrontRightMotor, RearLeftMotor, ReaRearRightightMotor, FrontLeft_angle, FrontRight_angle, RearLeft_angle, ReaRearRightight_angle, x_wheelbase=2, y_wheelbase=2, speed=5):
    """
    ...
    :param ReaRearRightightMotor: Right rear motor value (-1 to 1); 1 is forward
    ...
    :param ReaRearRightight_angle: Right rear motor angle in degrees (0 to 360)
    ...
    RearRight = ReaRearRightightMotor * speed
    ...
    RearRight_rad = ReaRearRightight_angle * (math.pi / 180)
